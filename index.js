...
function removeEmployee() {
    ...
    inquirer.prompt([
        ...
        if (roleAssign != "[ CANCEL ]") {
            ...
            db.query(query, (err, res) => {
                console.info(`Removed employee ID`+roleAssign);
            })
        } else {
            console.info(`[Did not Remove]`);            
        }
        askQuestion();
    })
    })
...
function addEmployee() {
    ...
    inquirer.prompt([
        ...
        db.query(query, (err, res) => {
        console.info(`added new employee`);
        askQuestion();
        })
...
function addRole() {
    ...
    inquirer.prompt([
        ...
        db.query(query, (err, res) => {
            ...
            db.query(query, (err, res) => {
                if (err) throw err;
                console.info(`added new role of: `+addRoleTitle);
                askQuestion();
            })
...
function removeRole() {
    ...
    db.query(query, (err, res) => {
        ...
        if (roleAssign != "[ CANCEL ]") {
            ...
            db.query(query, (err, res) => {
                console.info(`Removed role ID #`+roleAssign);
            })
        } else {
            console.info(`[Did not Remove]`);            
        }
...
function addDepartment() {
    inquirer.prompt([
        ...
        db.query(query, (err, res) => {
            console.info(`added new department`);
            askQuestion();
        })
...
function removeDepartment() {
    ...
    db.query(query, (err, res) => {
        ...
        if (departmentAssign != "[ CANCEL ]") {
            ...
            db.query(query, (err, res) => {
                console.info(`Removed Department ID #`+departmentAssign);
            })
        } else {
            console.info(`[Did not Remove]`);            
        }
...
function updateManager() {
    ...
    db.query(query, (err, res) => {
        ...
        inquirer.prompt([
            ...
            db.query(query, (err, res) => {
                console.info(`Updated Manager for `+employee+` to `+manager);
            })
            askQuestion();
        })
    })
    ...
    db.query(query, (err, res) => {
        ...
        inquirer.prompt([
            ...
            if (role != "[ CANCEL ]") {
                ...
                db.query(query, (err, res) => {
                    console.info(`Updated Role for `+employee+` to be a `+role);
                })
            }
            askQuestion();
        })
    ...
    db.query(query, (err, res) => {
        ...
        inquirer.prompt([
            ...
            if (department != "[ CANCEL ]") {
                ...
                db.query(query, (err, res) => {
                    console.info(`Updated Department for `+role+` to be part of `+department);
                })
            }
            askQuestion();
        })
